...
export class Store {
    ...
    public getProductsAsync(): Promise<Product[] | undefined> {
    ...
    public getCategoriesAsync(): Promise<Category[] | undefined> {
    ...
    public getProductsByCategoryId(categoryId: string): Product[] {
        ...
        const copy = this.createDeepCopy(filteredProducts);
        return copy || [];
    }
    ...
    private createDeepCopy<T>(object: T): T | undefined {
        try {
